...
return {experimental = {ghost_text = true}, window = {documentation = {border = "solid"}, completion = {border = "solid"}}, preselect = cmp.PreselectMode.None, snippet = {expand = _5_}, mapping = mapping, sources = {{name = "orgmode"}, {name = "nvim_lsp"}, {name = "luasnip"}, {name = "buffer"}, {name = "path"}}, formatting = {fields = {"kind", "abbr", "menu"}, format = _6_}}