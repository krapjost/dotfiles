...
local function syn_stack()
  local syn_exists_3f = vim.fn.exists(".synstack")
  if syn_exists_3f then
    return print(vim.fn.synstack(vim.fn.line("."), vim.fn.col(".")))
  else
    return nil
  end
end
...
return vim.keymap.set("n", "<C-f>f", ":<C-r><C-w>")